...
import json
from .kubernetes_api import is_have_namespace, create_namespace_in_cluster
...
def create_argocd_cluster(argo_url: str, argo_bearer_token: str, cluster_server: str, cluster_name: str,
                          cluster_token: str, cluster_ca: str):
